...
<!-- End Google Tag Manager -->
  ...
  <meta name="description" content="Alla kommande running events och weekly runs i Stockholm, Göteborg och Malmö — från run clubs, crews och communions.">
...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  ...
  <header class="page-header">
    <div class="page-header-inner">
      ...
      <p>Alla kommande running events från Strava och weekly runs från löpargrupper, run clubs och run crews i Stockholm, Göteborg och Malmö.</p>
    </div>
  </header>
