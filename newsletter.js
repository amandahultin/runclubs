...
(function () {
  ...
  function openModal() {
    ...
    void modalBox.offsetWidth; // force reflow to re-trigger animation
  ...
  async function submitToSheet(extraFields) {
    ...
    try {
      ...
      // no-cors won't return status; show thanks regardless
    }
    pendingData = null;
  }
  ...
  // Sticky newsletter button on nyheter.html
